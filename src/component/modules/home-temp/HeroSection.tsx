      ...
      <div className="absolute left-1/2  lg:left-[16.6667%] top-[14%] -translate-x-1/2 lg:translate-x-0 ">
        <div className="flex flex-col items-start gap-6 ">
          ...
          <div className="flex items-center gap-4 px-3">
            <p className="text-secondary font-vazir font-medium whitespace-nowrap text-sm lg:text-base">روانشناس</p>
            <p className="text-secondary-foreground font-vazir font-medium text-sm lg:text-base">.</p>
            <p className="text-secondary font-vazir font-medium whitespace-nowrap text-sm lg:text-base">روان درمانگر</p>
            <p className="text-secondary-foreground font-vazir font-medium text-sm lg:text-base">.</p>
            <p className="text-secondary font-vazir font-medium whitespace-nowrap text-sm lg:text-base">زوج درمانگر</p>
            <p className="text-secondary-foreground font-vazir font-medium text-sm lg:text-base hidden md:block">.</p>
            <p className="text-secondary font-vazir font-medium whitespace-nowrap text-sm lg:text-base hidden md:block">طرحواره درمانگر</p>
          </div>
        </div>
      </div>
    </div>
