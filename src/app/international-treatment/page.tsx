...
export const metadata: Metadata = {
  ...
  description: "معرفی بهترین روانشناس ایرانی برای ایرانیان داخل و خارج از کشور با زوج‌درمانی، مشاوره ازدواج و درمان فردی به‌صورت حضوری و آنلاین.",
  keywords: [
    "روانشناس ایرانی",
    "بهترین روان‌درمانگر",
    "زوج درمانگر",
    ...
    <div className="max-w-5xl mx-auto px-5 pt-32 pb-16">
      <JsonLd
        ...
        data={[
          ...
          webPageSchema({
            ...
            description: "بهترین روانشناس ایرانی برای ایرانیان داخل و خارج از کشور با خدمات زوج‌درمانی، مشاوره ازدواج، مشاوره فردی و درمان آنلاین.",
          }),
        ]}
      />
      ...
      <section className="bg-white/70 border border-primary/10 rounded-2xl p-8 shadow-sm">
        ...
        <div className="grid sm:grid-cols-2 gap-3 mt-6">
          {[
            "روانشناس ایرانی آشنا با فرهنگ و خرده‌فرهنگ‌ها",
            "آموزش‌محور و کمک به مهارت‌آموزی کوتاه‌مدت",
            "تجربه، مدارک معتبر و چارچوب حرفه‌ای",
            "پاسخ‌گویی به نیازهای ایرانیان داخل و خارج از کشور",
          ].map((item) => (
      ...
      <section className="mt-10 grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white/70 border border-primary/10 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-foreground/80 font-vazir !leading-9 mb-4">
            تا به حال به این موضوع فکر کرده‌اید که چرا آدم‌ها در موقعیت‌های مختلف متفاوت عمل می‌کنند؟ دنیای امروز پر از تضادهای درونی و بیرونی است؛ تضادهایی که ایرانی‌ها مخصوصاً مهاجران با انواع آن‌ها
            آشنایی کامل دارند. برخی افراد بنا به هر دلیلی آموخته‌های مناسب و سودمندی در چنته ندارند. در چنین شرایطی مداخله و حضور یک روانشناس ایرانی با تجربه مخصوصاً برای ایرانیان خارج از کشور اهمیت
            زیادی پیدا می‌کند. اما به چه کسی می‌توان اعتماد کرد؟
          </p>
      ...
      <section className="mt-10 grid lg:grid-cols-2 gap-6">
        <div className="bg-white/70 border border-primary/10 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-foreground/80 font-vazir !leading-9 mb-4">
            دکتر مرضیه خمسه یک طرحواره درمانگر و روانشناس ایرانی عضو انجمن روانشناسی امریکا (APA) و عضو سازمان نظام روانشناسی و مشاوره کشور با کد شماره ۸۱۸۵ است که ضمن فعالیت حرفه‌ای در شهر تهران
            آماده‌ی خدمت‌رسانی به ایرانیان خارج از کشور می‌باشد.
          </p>
          <p className="text-foreground/80 font-vazir !leading-9">
            خانم دکتر مرضیه خمسه دارای بیش از ۱۵ سال سابقه مشاوره و درمان حضوری و غیرحضوری در حوزه‌های گوناگون است و برای ایرانیان خارج از کشور روزنه‌ای مطمئن فراهم کرده‌اند.
          </p>
        </div>
        <div className="bg-white/70 border border-primary/10 rounded-2xl p-6 shadow-sm">
      ...
      <section className="mt-10 grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white/70 border border-primary/10 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-foreground/80 font-vazir !leading-9 mb-4">
            فارغ از این که همسر مورد نظرتان ایرانی یا خارجی است، می‌توانید در مشاوره‌های پیش از ازدواج دکتر خمسه شرکت کنید و تست‌های مختلف را انجام دهید. طی مشاوره ازدواج، ضمن بررسی شخصیت، طرحواره‌ها،
            اعتقادات و باورهای طرفین، میزان ریسک یک رابطه مشخص خواهد شد.
          </p>
          <p className="text-foreground/80 font-vazir !leading-9 mb-4">
        ...
        <div className="bg-white/70 border border-primary/10 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-foreground/80 font-vazir !leading-8 mb-4">
            دکتر مرضیه خمسه با جدیدترین رویکردهای زوج درمانی به رابطه شما نگاه می‌کند و از شما حمایت می‌کند تا از مارپیچ مشاجرات خارج شوید و دوباره یک رابطه رضایت‌بخش داشته باشید.
          </p>
      ...
      <section className="mt-10 grid lg:grid-cols-2 gap-6">
        <div className="bg-white/70 border border-primary/10 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-foreground/80 font-vazir !leading-9">
            روانشناسی نوجوان و بلوغ زیرمجموعه‌ای از روانشناسی رشد است. نوجوان‌هایی که به کشورهای غربی مهاجرت می‌کنند با کمک یک روان‌درمانگر و مشاوره فردی می‌توانند این دوران پر تلاطم را به خوبی پشت سر
            بگذارند.
          </p>
        </div>
        <div className="bg-white/70 border border-primary/10 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-foreground/80 font-vazir !leading-9 mb-4">
            در درمان انفرادی جلساتی با مشارکت مراجعه کننده و درمانگر برگزار می‌شود. درمانگر با تمرکز بر شکایت و انتظارات فعلی، بر خودشناسی و افزایش توانایی ارائه راه‌حل کار می‌کند.
          </p>
          <p className="text-foreground/80 font-vazir !leading-9">مدت زمان جلسات ۴۵ دقیقه است و تناوب جلسات با توجه به نیاز مراجعه‌کننده از یک‌بار در هفته تا هر دو هفته یک‌بار قابل تنظیم است.</p>
        </div>
      </section>
      ...
      <section className="mt-10 grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white/70 border border-primary/10 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-foreground/80 font-vazir !leading-9 mb-4">
            با چند جلسه درمان به شما کمک می‌کنیم تا مشکلات مختلفی مانند فرسودگی شغلی، احساسات سرکوب شده، اختلالات اضطرابی، حملات پانیک و... را حل کنید. برای رزرو وقت مشاوره آنلاین می‌توانید در تلگرام،
            واتساپ و ایمو پیام بدهید یا تماس بگیرید.
          </p>
          <p className="text-foreground/80 font-vazir !leading-9">
        ...
        <div className="bg-white/70 border border-primary/10 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-foreground/80 font-vazir !leading-8">
            ارتباط از هر کشوری امکان‌پذیر است؛ از کشورهای آسیای شرقی تا اروپا، آمریکا و حوزه خلیج فارس. ایرانیان خارج از کشور می‌توانند از مشاوره فردی، مشاوره ازدواج و زوج‌درمانی بهره ببرند.
          </p>
        </div>
      </section>
      ...
      <section className="mt-10 grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white/70 border border-primary/10 rounded-2xl p-6 shadow-sm">
          ...
          <p className="text-foreground/80 font-vazir !leading-9 mb-4">
            طرحواره درمانی یکی از کوتاه‌ترین روش‌ها برای افزایش بینش در افراد به حساب می‌آید و رویکرد CBT را نیز تکمیل می‌کند. در این مسیر کنار شما خواهیم بود تا با کمترین تنش و اضطراب از تله‌ها و
            الگوهای ناسازگار رهایی یابید.
          </p>
          <p className="text-foreground/80 font-vazir !leading-9">هنگام درمان تله‌ها (طرحواره‌ها) ابتدا باید فهمید که آن‌ها چطور شکل گرفته‌اند و چگونه در رفتارها و انتخاب‌ها دخالت می‌کنند.</p>
        </div>
      </section>
    </div>
  );
